                      ...
                      <div class="login-space">
                          <div class="login">
                              <div class="group">
                                  ...
                                  <input id="user" type="text" class="input" placeholder="Input your id">
                              </div>
                              <div class="group">
                          ...
                          <form action="/member/join" role = "form" method="post" class="sign-up-form">
                          	  <div class="group">
                                  <label for="user" class="label">Id</label>
                                  <input id="user" type="text" class="input" placeholder="Create your Id" name="id">
                              </div>
                              <div class="group">
                                  <label for="pass" class="label">Password</label>
                                  <input id="pass" type="password" class="input" data-type="password"
                              ...
                              <div class="group">
                                  ...
                                  <input id="pass" type="password" class="input" data-type="password"
                                      placeholder="Repeat your password" id="password_repeat" name="password_repeat">
                              </div>
                              <div class="group">
                                  <label for="user" class="label">name</label>
                                  <input id="user" type="text" class="input" placeholder="Input your name" name="name">
                              </div>
                              <div class="group">
                                  <label for="pass" class="label">Email Address</label>
                                  <input id="pass" type="text" class="input" placeholder="Input your email address" name="email">
                              </div>
                              <div class="group">
                                  <label for="pass" class="label address2" name="address">Address</label>
                                    <!-- kakao 주소 api-->
